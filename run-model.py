...
if __name__ == "__main__":
    ...
    parser.add_argument("--ml-model", type=str, required=True, help="Caminho para o arquivo .json com o modelo treinado")
    parser.add_argument("--data", type=str, required=True, help="Caminho para o arquivo .zarr com os dados")
    ...
    parser.add_argument("--output", type=str, default=None, help="Local para salvar atributo sismico")
